...
이 문서는 2026-W23 지식 수집·업데이트·Obsidian 반영 흐름을 주간 실행 계획과 리뷰 지표로 정리한다. 리뷰의 목적은 노력량 보고가 아니라 위험 감소, 납품 지원, 반복 감소, 고립 지식 감소를 확인하는 것이다. - 위험 감소: 보안검토 후보는 유용성보다 원문 링크 차단과 익명화가 먼저다. - 납품 지원: 납품 검수 지식은 QA, 고객지원, SOP로 연결될 때 실제 가치가 생긴다.
