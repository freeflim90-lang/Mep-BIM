...
**LUA BIM LABS Starter — Track 7 Quick Reference** *Track completion card — Day 54* ``` Site condition differs from model or drawing ↓ Site supervisor raises formal RFI (Assigned RFI number, description, photo) ↓ RFI submitted to BIM Coordinator / Engineer
