...
> 관련 원건: `cases/AITEST_20260606_030.md` > 관련 세션: `AICOL-20260606-030` > 준비 리허설: `cases/AITEST_20260606_031.md` > 상태: Draft, 고객 확정 응답 전 `AITEST_20260606_030`은 고객 확정 응답 전까지 `REDACTED_REVIEW`와 `ESCALATED`를 유지한다. 이 초안은 2026-06-13 재판정 입력물이며, 승인 전에는 고객에게 확정 기준으로 전달하
