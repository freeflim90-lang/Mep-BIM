...
문서상태: Draft Created 작성일: 2026-06-06 재판정 예정일: 2026-06-12 Starter-only 출시 기준과 Project Mentor 가격/약관/결제 링크 문서가 충돌했다. 현재 임시 원칙은 `APPROVED_WITH_HOLD / Starter-only`이며, Starter 외 상품은 Coming Soon 또는 Consultation-only로 유지한다.
