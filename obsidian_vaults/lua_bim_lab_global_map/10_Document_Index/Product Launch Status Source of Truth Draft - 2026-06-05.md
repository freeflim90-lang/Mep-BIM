...
문서상태: CEO/CFO 승인 전 초안 관련 케이스: `cases/AITEST_20260605_007.md` 목적: 고객에게 공개 가능한 상품, 가격, 결제 링크, Coming Soon 문구의 단일 기준을 정리한다. CEO/CFO가 최종 승인하기 전까지 공개 판매 가능한 상품은 Starter만으로 본다. Project Mentor Standard/Intensive 및 상위 멘토링 상품은 준비 문서 또는 별도 상담 후보로만 취급한다.
