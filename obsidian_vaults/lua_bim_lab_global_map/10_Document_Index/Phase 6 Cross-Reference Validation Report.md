...
**Date:** 2026-03-06 **Validator:** validate-structure agent **Scope:** All 61 skills in skills/ directory 1. **SKILL.md** exists in skill directory 2. **references/** directory exists with `methods.md`, `examples.md`, `anti-patterns.md` (all 3 required)
