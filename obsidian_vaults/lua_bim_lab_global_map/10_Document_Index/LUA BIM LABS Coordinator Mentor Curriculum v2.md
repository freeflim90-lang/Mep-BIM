...
문서번호: LBL-TRN-PUB-003 문서상태: Coming Soon 상품 커리큘럼 계획 — v2 가격-가치 정렬 개발판 작성일: 2026-05-29 가격: USD 229/월 (→ 2027 Q3 USD 279 예정, 월간 세션 + 템플릿 팩 정규화 후) 전달 방식: Telegram 1:1 + **월 1회 30분 음성/Zoom 세션** + 주간 이슈 리뷰 + **조율 템플릿 팩** + **월간 케이스 스터디**
