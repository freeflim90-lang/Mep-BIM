...
> 목적: `AITEST_20260605_006`, `AITEST_20260605_007`의 2026-06-12 재판정 결과가 승인, 명시적 보류, 조건부 보완, 위반 중 무엇이든 일관된 순서로 문서에 반영되도록 한다. 이 플레이북은 2026-06-06 기준 현재 상태를 닫지 않는다. 재판정일에 실제 승인자/결정자가 선택한 결과를 반영하는 실행 순서만 정의한다. 분기별 기대 상태와 자동 감사 불변조건은 `REDECISION_BRANCH_SIMULATION_202
