...
문서상태: CEO/법무/보안관 승인 전 초안 관련 케이스: `cases/AITEST_20260605_006.md` 목적: 개인정보, 고객 데이터, 프로젝트 정보가 포함된 AI 협업 세션에서 외부 AI 사용 가능 여부를 단일 기준으로 정리한다. CEO, 법무조항검토, 라이선스_보안관이 별도 승인하기 전까지 고객/프로젝트/개인정보/계약 데이터가 포함된 자료는 외부 AI에 전송하지 않는다. 고객에게는 아래 원칙으로 답변한다.
