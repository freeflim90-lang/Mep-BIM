...
- Source: Revit 공식 템플릿 가이드, 국내 발주처 BIM 지침, LUA BIM LABS 내부 표준 - Tags: bim-template,shared-parameters,naming,view-filter,2026 **AI 즉시 답변 패턴 — "BIM 프로젝트 시작할 때 템플릿은 어떻게 구성하나요?"** ``` Revit 프로젝트 템플릿(.rte) 핵심 구성: 1. 공유 파라미터 파일: 프로젝트 전체 공통 파라미터 정의
