...
문서번호: LBL-LAUNCH-000 문서상태: 운영 마스터 체크리스트 작성일: 2026-05-29 - [x] PayPal Payment Link 생성 완료 (https://www.paypal.com/ncp/payment/9NQE7BEG2M7PS) - [x] Google Form 신청서 완성 - [x] Google Sheet 신청 관리 시트 운영 중 - [x] Terms and Disclaimers 문서 완성
