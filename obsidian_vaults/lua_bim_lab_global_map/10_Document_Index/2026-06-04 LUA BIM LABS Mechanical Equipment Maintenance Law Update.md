...
국가법령정보센터의 기계설비법, 기계설비 유지관리기준, 시행령 제정·개정이유를 기준으로 LUA BIM LABS의 공조·위생·설비장비·FM BIM 검토에 필요한 기계설비 유지관리/성능점검 운영 기준을 정리한다. 이 문서는 법률 자문이 아니라 `needs-review` 지식 업데이트이며, 실제 프로젝트 적용 전 최신 법령·고시 전문, 발주처 요구, 유지관리 주체, 기계설비 전문가 확인을 거친다. 공조배관, 공조덕트, 위생, 자동제어, 설비장비 BIM은 납품 시 형상과
