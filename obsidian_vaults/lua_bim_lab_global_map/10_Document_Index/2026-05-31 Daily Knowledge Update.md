...
source_path: "knowledge/40_curation/updates/daily/2026-05-31_DAILY_KNOWLEDGE_UPDATE.md"
---
...
`knowledge/40_curation/updates/daily/2026-05-31_DAILY_KNOWLEDGE_UPDATE.md`

Absolute path:

`/Users/choejeong-yeon/LUA BIM LABS/knowledge/40_curation/updates/daily/2026-05-31_DAILY_KNOWLEDGE_UPDATE.md`
...
생성 시각: 2026-05-31 13:40:04 - [x] 일일 지식 업데이트 리포트 생성 - [x] Model Quality Auditor Obsidian 그래프 갱신 - [x] LUA BIM LAB 전역 Obsidian 지식맵 갱신 - [ ] 신규 문서가 외부 공개 가능 문서인지 내부 전용 문서인지 분류한다. - [ ] 오류 오답노트에 원인, 수정, 검증, 재발 방지가 모두 채워졌는지 확인한다.
