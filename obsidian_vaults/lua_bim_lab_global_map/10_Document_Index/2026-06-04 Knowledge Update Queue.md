...
이 문서는 2026-06-04 지식 수집·업데이트·Obsidian 반영 결과를 실제 실행 큐로 전환한 운영 노트다. 자동 분류 리포트가 검토 대상을 보여준다면, 이 큐는 오늘 먼저 처리할 항목과 보류할 항목을 정한다. - 확정 지식은 관련 위키링크 2개 이상과 다음 검토일을 포함한다. - 보안검토 항목은 원문 링크를 남기지 않고 보안검토 기록만 남긴다. - Watch 항목은 확정 문서가 아니라 후보 상태와 다음 확인일을 기록한다.
