...
- `knowledge/10_agents/02_견적팀/건축.md` · score `30`
- `knowledge/20_qa/건축_QA.md` · score `35`
- `knowledge/10_agents/90_확장에이전트/BIM_건물유형_공사구분_산정로직.md` · score `16`
- `knowledge/10_agents/90_확장에이전트/BIM_프로젝트_견적산정.md` · score `15`
