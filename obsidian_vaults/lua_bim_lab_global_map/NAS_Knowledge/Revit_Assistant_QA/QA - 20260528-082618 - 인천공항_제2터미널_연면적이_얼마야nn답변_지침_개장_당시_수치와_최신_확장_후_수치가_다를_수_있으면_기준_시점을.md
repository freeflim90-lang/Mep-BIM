...
- `knowledge/20_qa/건축_QA.md` · score `43`
- `knowledge/10_agents/90_확장에이전트/BIM_지침서.md` · score `29`
- `knowledge/10_agents/90_확장에이전트/설계_지침서.md` · score `23`
- `knowledge/10_agents/90_확장에이전트/시공_지침서.md` · score `22`
