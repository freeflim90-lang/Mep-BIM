...
- knowledge/10_agents/90_확장에이전트/BIM_지침서.md (score 33)
- knowledge/10_agents/90_확장에이전트/인프라_DevOpsObsidian.md (score 30)
- knowledge/10_agents/90_확장에이전트/Dynamo.md (score 30)
...
- `knowledge/10_agents/90_확장에이전트/인프라_DevOpsObsidian.md` · score `30`
- `knowledge/10_agents/90_확장에이전트/Dynamo.md` · score `30`
- `knowledge/10_agents/05_애드인개발팀/빌드검증.md` · score `29`
