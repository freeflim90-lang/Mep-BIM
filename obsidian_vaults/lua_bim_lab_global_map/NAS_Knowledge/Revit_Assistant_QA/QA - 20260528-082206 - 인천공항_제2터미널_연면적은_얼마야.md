...
근거 문서:
- data/knowledge_base/Revit_Addin.md (score 79)
- data/knowledge_base/BIM_지침서.md (score 39)
- data/knowledge_base/Dynamo.md (score 38)
...
- `data/knowledge_base/Dynamo.md` · score `38`
- `docs/ADDIN_DEVELOPMENT_PLAN.md` · score `33`
- `data/knowledge_base/Navisworks_Addin.md` · score `32`
