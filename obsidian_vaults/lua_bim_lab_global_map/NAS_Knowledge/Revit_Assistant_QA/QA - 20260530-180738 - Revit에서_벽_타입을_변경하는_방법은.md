...
근거 문서:
- knowledge/10_agents/05_애드인개발팀/Revit_Addin.md (score 68)
- knowledge/10_agents/05_애드인개발팀/Navisworks_Addin.md (score 36)
- knowledge/10_agents/90_확장에이전트/인프라_DevOpsObsidian.md (score 33)
- knowledge/10_agents/90_확장에이전트/CS_기술지원관.md (score 32)
...
- `knowledge/10_agents/90_확장에이전트/인프라_DevOpsObsidian.md` · score `33`
- `knowledge/10_agents/90_확장에이전트/CS_기술지원관.md` · score `32`
- `knowledge/10_agents/90_확장에이전트/프로그램개발.md` · score `30`
