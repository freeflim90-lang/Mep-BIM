...
```text
Project: 인천공항 테스트`nActive View: 1F`n`n요소명: duct`n카테고리: 덕트`nID: 123
```
...
근거 문서:
- knowledge/10_agents/05_애드인개발팀/Revit_Addin.md (score 76)
- knowledge/10_agents/90_확장에이전트/BIM_지침서.md (score 46)
- knowledge/10_agents/90_확장에이전트/Dynamo.md (score 43)
- knowledge/20_qa/건축_QA.md (score 41)
...
- `knowledge/10_agents/90_확장에이전트/Dynamo.md` · score `43`
- `knowledge/20_qa/건축_QA.md` · score `41`
- `knowledge/20_qa/공조덕트_QA.md` · score `41`
