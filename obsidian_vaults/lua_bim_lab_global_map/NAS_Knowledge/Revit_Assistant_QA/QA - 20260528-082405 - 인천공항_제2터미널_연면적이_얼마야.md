...
- data/knowledge_base/BIM_지침서.md (score 46)
- data/knowledge_base/Dynamo.md (score 43)
- data/knowledge_base/qa/건축_QA.md (score 41)
...
- `data/knowledge_base/Dynamo.md` · score `43`
- `data/knowledge_base/qa/건축_QA.md` · score `41`
- `data/knowledge_base/qa/공조덕트_QA.md` · score `41`
