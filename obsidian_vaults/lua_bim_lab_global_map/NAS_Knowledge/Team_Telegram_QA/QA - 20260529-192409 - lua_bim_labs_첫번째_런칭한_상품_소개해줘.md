...
- `knowledge/10_agents/90_확장에이전트/BIM_시장_규모분석.md` · score `35`
- `knowledge/10_agents/90_확장에이전트/BIM_시방서.md` · score `34`
- `knowledge/10_agents/90_확장에이전트/BIM_제안서.md` · score `34`
- `knowledge/10_agents/90_확장에이전트/BIM_지침서.md` · score `34`
