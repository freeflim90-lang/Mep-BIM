...
- `knowledge/10_agents/90_확장에이전트/BIM_건물유형_공사구분_산정로직.md` · score `26`
- `knowledge/10_agents/03_엔지니어링팀/소방기계.md` · score `18`
- `knowledge/10_agents/03_엔지니어링팀/공조덕트.md` · score `17`
- `knowledge/10_agents/90_확장에이전트/BIM_등급별_투입일_기준표.md` · score `17`
