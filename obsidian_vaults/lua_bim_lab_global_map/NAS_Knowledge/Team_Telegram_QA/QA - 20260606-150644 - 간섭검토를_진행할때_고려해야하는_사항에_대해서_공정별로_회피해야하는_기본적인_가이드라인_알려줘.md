...
- `data/knowledge_base/BIM_템플릿기획관.md` · score `16`
- `data/knowledge_base/설비장비.md` · score `16`
- `data/knowledge_base/BIM_제안서.md` · score `15`
- `data/knowledge_base/시공_시방서.md` · score `14`
...
추가 요청: 추가 설명 없음
보강 등록 위치: data/knowledge_base/qa/지식업데이트_QA.md
자동 수집 위치: data/knowledge_base/qa/지식업데이트_QA.md
