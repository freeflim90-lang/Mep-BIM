...
- `knowledge/10_agents/90_확장에이전트/BIM_템플릿기획관.md` · score `16`
- `knowledge/10_agents/90_확장에이전트/설비장비.md` · score `16`
- `knowledge/10_agents/90_확장에이전트/BIM_제안서.md` · score `15`
- `knowledge/10_agents/90_확장에이전트/시공_시방서.md` · score `14`
...
## 피드백 - 보강요청 (2026-06-06 15:07:05)

추가 요청: 추가 설명 없음
보강 등록 위치: knowledge/20_qa/지식업데이트_QA.md
자동 수집 위치: knowledge/20_qa/지식업데이트_QA.md
