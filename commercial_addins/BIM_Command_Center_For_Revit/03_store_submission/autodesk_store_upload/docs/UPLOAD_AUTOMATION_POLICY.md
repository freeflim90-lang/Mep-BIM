...
- Build output collection after owner builds on Revit/Navisworks machine
...
- Keep commercial release files under `commercial_addins/BIM_Command_Center_For_Revit`.
...
- Owner performs Autodesk API dependent build and runtime validation outside Codex.
