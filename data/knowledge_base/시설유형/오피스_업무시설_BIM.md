...
## 2026-06-06 오피스 ZEB 의무화·그린리모델링 BIM 보강
- Source: 국토안전관리원 그린리모델링창조센터, ZEB 로드맵 2025, 전기신문 탄소중립 건물 2025, 국토부 정책브리핑
- Tags: office-bim,zeb,green-remodeling,carbon-neutral,bim,2025,2026

**오피스 ZEB 의무화 BIM 설계 임팩트 (2025~2026):**
- 건물 부문 온실가스: 국내 전체 온실가스 **24.7%** (2020년 기준) → 2050 탄소중립의 핵심 대상
- 오피스(업무시설) 1,000m² 이상: **2025.12.31~** ZEB 5등급 수준 설계 의무화
- BIM 설계 변화:
  - 에너지 해석 모델(OpenStudio/EnergyPlus) 동시 제출 요구 증가
  - 외피 단열·창호 U값·SHGC BIM 파라미터 → ZEB 시뮬레이션 직결
  - 신재생에너지 설비(태양광) 면적·용량 BIM 속성 의무화

**2026 그린리모델링 지원사업 — 오피스 BIM 수요 원천:**
| 사업명 | 대상 | 지원 내용 |
|-------|------|---------|
| 공공건축물 그린리모델링 2.0 | 노후 공공청사·업무시설 | 에너지 성능 개선 공사비 일부 지원 |
| 민간건축물 그린리모델링 컨설팅 | 민간 오피스·상업시설 | 에너지 진단 + 개선 설계 컨설팅 |
- 그린리모델링창조센터: 국토안전관리원 운영, 사업 신청·컨설팅 원스톱
- LUA BIM LABS 기회: 그린리모델링 사전 에너지 진단 BIM + 개선 설계 BIM 패키지

**BIM 의무화 단계적 확대 — 오피스 발주 BIM 수요 예측:**
| 시점 | 기준 | 오피스 적용 규모 |
|------|------|-------------|
| 현재 | 1,000억원 이상 | 대형 오피스 타워만 해당 |
| 2026년 | **500억원 이상** | 중대형 오피스 BIM 의무 급증 |
| 2028년 | **300억원 이상** | 중소형 오피스도 포함 |
- 2026년 500억원 기준 적용 → 오피스 BIM 수주 물량 **약 2배** 증가 예상

**탄소 중립 오피스 BIM 파라미터 강화:**
```
Pset_CarbonNeutralOffice:
  - Annual_GHG_kgCO2e_m2: 연간 온실가스 배출 원단위
  - Scope1_kgCO2e: 직접 배출 (가스보일러 등)
  - Scope2_kgCO2e: 간접 배출 (전력 사용)
  - ZEB_Grade_Achieved: 달성 등급 (인증 후 갱신)
  - GreenRemodeling_Year: 그린리모델링 완료 연도
  - GSEED_Rating: G-SEED 등급
  - BEMS_Install_Date: BEMS 설치 연도
```

**오피스 BIM → BEMS 통합 운영 사례 (2025~2026):**
- 대형 오피스 발주처 요구: 준공 BIM → BEMS(건물에너지관리시스템) 연동 자산 데이터 납품
- COBie 확장: 에너지 미터·센서·공조기 속성 → BEMS 초기 설정 데이터 자동 생성
- 수요 증가 배경: ZEB 인증 유지 의무 → 실측 에너지 데이터 BEMS 모니터링 법적 요구

관련: [[사옥_기업본사_BIM]] · [[일반건물_빌딩_BIM]] · [[패시브하우스_PHIKO]] · [[FM_자산관리]]
