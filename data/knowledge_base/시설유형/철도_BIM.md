...
## 2026-06-06 국가철도공단 BIM 의무화·충북선 고속화 BIM 보강
- Source: 전자신문 철도BIM 2025, 국가철도공단 BIM 설계대가 기준, 철도연 BIM 적용지침, 국토부 BIM 시행지침
- Tags: railway-bim,national-railroad,bim-mandate,chungbuk-line,design-fee,2025,2026

**국가철도공단 철도 BIM 의무화 단계적 확대 (2025~2028):**
| 시점 | 대상 | 비고 |
|------|------|-----|
| 현재 (2025) | **1,000억원 이상** 신규 공공 공사 | 건설 전 과정 BIM 의무 |
| **2026년~** | **500억원 이상** 신규 공공 공사 | 순차 확대 |
| **2028년~** | **300억원 이상** 신규 공공 공사 | 최종 단계 |
| 2030년 목표 | **모든 공공 공사** | 국토부 BIM 로드맵 최종 목표 |

**국가철도공단 BIM 6개 분야 설계대가 기준 수립 (2025 진행):**
- 대상 분야: ① 건축 ② 전철전력 ③ 신호 ④ 통신 ⑤ 기계 ⑥ 차량기지
- 목적: 철도 BIM 설계 적정 대가 기준 마련 → 발주처 BIM 예산 산정 근거
- LUA BIM LABS 기회: 6개 분야 BIM 설계 용역 참여 → MEP(기계·전철전력) 특화 납품

**충북선 고속화 사업 — 전면 BIM 적용 첫 사례 (국내 철도 BIM 레퍼런스):**
- 사업 내용: 청주~제천 간 충북선 고속화 (최고속도 향상, 선로 개량)
- BIM 특이사항: 국내 철도 사업 최초 전면 BIM 적용 → 설계·시공 전 단계 BIM 일원화
- 인프라 BIM 적용지침: 한국철도기술연구원 + 국가철도공단 공동 개발 완료
  - 적용 범위: 설계 → 시공 → 운영 전 생애주기 BIM 관리
  - IFC 4.3 Alignment 기반 선형 BIM 표준화

**철도 BIM 현재 과제 — "BIM은 현실, 남은 과제는 실행력" (전자신문 2025.8):**
- 철도 BIM 도입 자체는 완료, 실제 현장 적용 실행력 강화가 핵심 과제
- 발주처·설계사·시공사 간 BIM 수준 격차 → 표준화 필요
- 철도 BIM 전문 인력 부족 → 교육·자격 체계 미흡

**LUA BIM LABS 철도 BIM 대응 전략 (의무화 확대 대비):**
- 2026년 500억원+ 의무화 → 신규 진입 물량 급증 → 철도 MEP BIM 전문 팀 구성
- 국가철도공단 협력사 등록 → BIM 설계 하도 용역 참여 (전철전력·기계 분야 특화)
- 철도 BIM 설계대가 기준 확정 시 → 적정 대가 기반 BIM 수주 경쟁력 확보

관련: [[지하철역사_BIM]] · [[IFC_OpenBIM]] · [[BIM_납품검수]] · [[건설_얼라이언스_분석]]
