...
## AI 토큰 최적화 최신 기법 (2026-05-31)
- Source: auto-enrich via Naver+Tavily+Google+DDG+Ollama 2026-05-31
- Tags: token-optimization,AI,cost,update

- 프롬프트 캐싱 기법을 활용하여 동일한 질문이나 요청에 대해 반복적으로 API 호출을 줄입니다.
- 응답 압축 알고리즘을 적용하여 데이터 크기를 최소화하고, 이를 통해 토큰 비용을 절감합니다. 
- 모델 선택 시 입력 및 출력 토큰 비용 차이를 고려하여 Opus 모델보다 Sonnet 모델을 우선적으로 사용합니다.
- 필요에 따라 프롬프트를 최적화하고 간결하게 작성하여 불필요한 정보를 제거합니다.
- 관련: [[BIM_건물유형_공사구분_산정로직]] · [[프로젝트분석]] · [[견적서담당]] · [[프롬프트엔지니어]]


## AI 토큰 최적화 최신 기법 (2026-06-01)
- Source: auto-enrich via Naver+Tavily+Google+DDG+Ollama 2026-06-01
- Tags: token-optimization,AI,cost,update

- 프롬프트 캐싱 사용: 프롬프트의 반복적인 요청을 줄이고 비슷한 질문에 대한 응답을 저장하여 재사용합니다.
- 응답 압축 기법 적용: API 응답 크기를 줄여 토큰 수를 최소화합니다. 이는 모델 선택 시 고려해야 합니다.
- 효율적인 모델 선택: Opus 4.8 모델을 사용하여 성능과 비용 간 균형을 맞춥니다. 이를 위해 OpenClaw 같은 도구를 활용할 수 있습니다.
- 관련: [[BIM_건물유형_공사구분_산정로직]] · [[프로젝트분석]] · [[견적서담당]] · [[프롬프트엔지니어]]
