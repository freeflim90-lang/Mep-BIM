...
def extract_element_features_from_ifc(ifc_path: Path, element_type: str) -> pd.DataFrame:
    ...
    for element in elements:
        ...
        # Mid-Elevation: average of bottom and top elevations
        mid_elev = None
...
def run_anomaly_detection(df_features: pd.DataFrame,
    ...
    df_flagged (pd.DataFrame)
        ...
        - Anomaly Flag: discrete label (1 = normal, -1 = anomaly)
        - : continuous score the higher, the more normal; the lower, the more anomalous
    """
    ...
    df_flagged["Anomaly Flag"] = flags  # Discrete label (+1 / -1)
    df_flagged["Anomaly Score"] = scores  # Continuous anomaly score

    # 6. FUTURE: Optionally save the model to disk
...
#     )
#     print(df_beams.head())
#     print(df_beams[["Weight", "Length", "BottomElevation", "TopElevation", "Anomaly Flag", ""]].describe())
