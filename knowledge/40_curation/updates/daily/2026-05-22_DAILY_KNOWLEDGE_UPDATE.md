...
| 후보 | 승격 대상 | 담당 | 상태 |
|---|---|---|---|
|  | 표준문서 / 교육자료 / 상품자료 / QA 체크리스트 / 오류 오답노트 | 지식 큐레이션 | review |
...
- [x] 최근 변경 지식 자동 분류 실행
- 검수 리포트: `knowledge/40_curation/updates/curation/2026-05-22_DAILY_KNOWLEDGE_CURATION.md`
- 보안검토: 45
- 보강필요: 0
- 승격후보: 26
- 유지: 1
