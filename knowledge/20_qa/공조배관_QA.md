...
A: 다른 계통이므로 공간 공유 자체는 허용되지만, 명확한 이격과 식별 표시가 필요합니다. 냉수 배관 단열재 포함 외경과 위생 배관 사이 최소 50mm 이격을 유지합니다. 위생 배관(오수) 바로 위에 냉수 배관을 설치하면 결로수가 위생 배관에 떨어져 오염될 수 있으니 주의합니다. *(KST03 적용주의: 발주처 특기시방서 확인)*
