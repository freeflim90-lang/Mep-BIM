...
1. 기준 확인: `법무조항검토` 담당자는 이 질문을 단순 설명이 아니라 KST02 이상 운영 기준, 프로젝트 범위, 고객 영향도, 납품/계약 책임을 함께 확인하는 실무 판단 문제로 본다.
...
A: 프로젝트 납품 모델, 보고서, 데이터셋의 사용권과 소유권을 명시하고, LUA BIM LABS가 사전에 보유한 라이브러리, 공통 모듈, 자동화 스크립트, Add-in 소스는 별도 권리로 분리한다. 프로젝트 맞춤 개발물은 인도 범위, 수정권, 재사용권, 소스 제공 여부를 계약서 또는 SOW에 따로 적는다. 계약 검토 시에는 배경 IP, 고객 전용 산출물, 재사용 가능 모듈을 표로 정리해 내부 승인권자와 고객에게 공유·보고한다.
...
• [Naver] 최종 사용자 라이센스 계약(EULA)이란?
  ...
  source-url: https://www.servicenow.com/kr/products/it-asset-management/what-is-eula.html

• [Naver] 소프트웨어 사용권 동의
  일반적인 조항 한 연구에 따르면, 다양한 소프트웨어 서비스 간의 경제적 경쟁은 고객에게 더 유리한 EULA를 이끌어낸다. 재판매 미국 연방 법에 따르면 기업은 판매 대상을 제한할 수 있지만, 구매자가 제품을...
  source-url: https://ko.wikipedia.org/wiki/%EC%86%8C%ED%94%84%ED%8A%B8%EC%9B%A8%EC%96%B4_%EC%82%AC%EC%9A%A9%EA%B6%8C_%EB%8F%99%EC%9D%98
...
• [Naver] [IT 지식] 소프트웨어 라이선스 및 EULA는 무엇인가
  ...
  source-url: https://blog.naver.com/lifeyun24/222732291952
...
• [Naver] EULA - 최종 사용자 라이선스 계약
  ...
  source-url: https://ko.extendoffice.com/support/end-user-license-agreement.html
...
• DDG evidence 최종 사용자 라이선스 계약: Eula: 소프트웨어 또는 서비스에 대한 효과적인 Eula 작성 방법
...
• [Naver] 이용약관 - 니케
  ...
  source-url: https://nikke-kr.com/cbt/termsofservice/

• DDG evidence 면책 조항 및 책임 제한 샘플 조항 | Law Insider
  ...
  source-url: https://www.lawinsider.com/ko/clause/%EB%A9%B4%EC%B1%85-%EC%A1%B0%ED%95%AD-%EB%B0%8F-%EC%B1%85%EC%9E%84-%EC%A0%9C%ED%95%9C
...
• [Naver] 최종 사용자 라이선스 계약
  ...
  source-url: https://arenabreakout.com/terms-ko.html

• DDG evidence [법률 번역] Limitation Of Liability - 책임 제한 조항 예문 및 해설 (II)
  ...
  source-url: https://legaltranslation.tistory.com/357
...
• [Naver] 마켓플레이스 자산 EULA – Roll20 도움말 센터
  ...
  source-url: https://help.roll20.net/hc/ko/articles/360037254294

검토 기준: 공식 문서·최신성·적용성 확인 후 FAQ 승격.

## 2026-06-20 계약 책임 경계 실무 케이스 Q&A
- Source: `knowledge/40_curation/quality/2026-06-20_EXTENSION_AGENTS_PRACTICAL_CASE_LIBRARY.md`
- Tags: legal,contract,field-case,liability,eula,qa,2026

**Q: 고객이 "BIM 검토 결과가 틀리면 모든 손해를 배상하라"고 요구하면?**
A: 서비스 범위와 법적 보증을 분리한다. 검토 산출물은 의사결정 지원 자료이며 최종 설계·시공·인허가 책임과 다르다는 점을 조항에 명시한다. 책임 제한, 고객 제공 자료의 정확성, 전문가 최종 확인 조건을 함께 넣는다.
...
4. 리스크 경계: 비용, 일정, 안전, 개인정보, 법무, 고객 약속으로 번질 수 있는 내용은 즉답보다 확인 로그와 승인 경로를 우선한다. 불확실한 답은 '가능/불가'보다 확인 조건과 대안 2개를 함께 제시한다.
5. 답변 형식: 결론 1문장, 근거 2개, 확인할 자료 3개, 다음 행동 1개 순서로 응답한다. Source: LUA BIM LABS agent QA quality baseline. Tags: qa,quality,field-case,kst02,risk,2026.
**Q: 자동화 스크립트나 Add-in 결과를 법적 판정처럼 쓰려는 문구가 있으면?**
A: 삭제하거나 완화한다. "보장", "확정", "법규 적합" 같은 표현은 위험하며, "검토 후보", "자동 탐지 결과", "전문가 확인 필요"로 바꾼다. 고객 제출 문서에서는 면책 문구와 적용 범위를 같이 둔다.
...
4. 리스크 경계: 비용, 일정, 안전, 개인정보, 법무, 고객 약속으로 번질 수 있는 내용은 즉답보다 확인 로그와 승인 경로를 우선한다. 불확실한 답은 '가능/불가'보다 확인 조건과 대안 2개를 함께 제시한다.
5. 답변 형식: 결론 1문장, 근거 2개, 확인할 자료 3개, 다음 행동 1개 순서로 응답한다. Source: LUA BIM LABS agent QA quality baseline. Tags: qa,quality,field-case,kst02,risk,2026.
**Q: 고객 모델이나 데이터 제공 조항은 무엇을 확인하나요?**
A: 제공 목적, 보관 기간, 제3자 전송 여부, 삭제 요청, 민감정보 포함 여부를 확인한다. 실제 모델 파일은 영업/마케팅/학습용으로 재사용하지 않는다는 경계를 둔다.
