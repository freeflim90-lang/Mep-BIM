...
**AI 즉시 답변 패턴 — "2026년 한국 AX 지원사업이 있나요?"**
```
2026년 주요 AX 지원사업:
1. AX 원스톱 바우처: AI 개발·클라우드(GPU·SaaS)·데이터 구매 통합 지원
   - 대상: 중소·중견·대기업 모두 참여 가능
   - 지원 규모: 과제당 약 13억원 내외, 2년
2. 공공 AX 프로젝트: 공공기관 AI 전환 신규과제 모집 (조달)
3. M.AX 얼라이언스: 제조업 AI 전환 협력 (1,300개 기관 참여)
LUA BIM LABS 적용: AX 바우처 + 건설사 컨소시엄형 참여 검토
```

**한국 건설 AX 2025~2026 핵심 트렌드:**
| 분류 | 내용 | LUA BIM LABS 기회 |
|------|------|-----------------|
| BIM+AI 의무화 | 500억↑ 공공공사 BIM 의무 (2026) | MEP BIM 수요 급증 |
| 정부 AX 바우처 | AI 전환 기업 최대 13억 지원 | R&D 자금 확보 |
| 건설 AI 스타트업 | 대기업+AI 스타트업 컨소시엄형 증가 | 대형 건설사 협력 파트너 |
| MEP BIM 자동화 | DL이앤씨 등 MEP 완전 자동화 목표 | 교육·도구 수요 |
| OpenBIM 납품검증 | IDS/BCF 기반 납품 검수 도입 예고 | Model Quality Auditor |

**AX 전략 승격 매트릭스 (2026-06-05 업데이트):**
| 신호 분류 | 주요 내용 | 승격 판단 |
|---------|---------|---------|
| BIM+AI 의무화 확대 | 2026년 500억↑ 적용 | 교육·납품 지원 서비스 즉시 확대 |
| 정부 AX 지원 사업 | 바우처·공공 AX 신규과제 | AX 바우처 신청 타겟팅 필요 |
| 건설 AI 스타트업 생태계 | 컨소시엄형·스핀오프형 확대 | 대형 건설사 파트너십 협상 기회 |
| MEP BIM 자동화 수요 | 3D 모델 수준 → 데이터 활용 전환 | MEP AI Q&A 봇 고도화 우선 |
| OpenBIM 검증 | IDS/BCF 납품 검수 도입 예고 | MQA 제품 IDS 기능 추가 |

**LUA BIM LABS AX 성장 우선순위 (2026년 하반기):**
1. MEP BIM 교육 고도화: 텔레그램 AI 봇 → 구체적 수치·기준 즉시 답변
2. Model Quality Auditor: IFC/IDS 기반 납품 자동 검증 상용화
3. BIM Command Center: Autodesk App Store 제출 완료
4. AX 바우처 신청: 정부 지원 자금으로 R&D 가속화
5. 대형 건설사 파트너십: 컨소시엄형 BIM AI 협력 추진
...
**승격/관찰 후보 2: Python-Dynamo-Grasshopper-Revit API 자동화 교육**
- 관련 신호: 2번, 3번, 5번, 6번, 7번, 12번, 13번, 17번
- 판단: Starter/PM 교육 상품에 장비표, 파라미터, 시트/뷰 자동화 실습을 추가한다.
- 이유: AEC 자동화는 전문 개발자만의 영역이 아니라 실무자가 반복 업무를 줄이는 단계형 역량으로 바뀌고 있다.

**승격/관찰 후보 3: 국내 건설 AX 생태계**
- 관련 신호: 2번, 3번, 5번, 6번, 7번, 12번, 13번, 16번
- 판단: 국내 AX 기업/기술 카테고리 표와 파트너십 후보 분류를 생성한다.
- 이유: 국내 건설 AI는 설계 자동화, 원가·견적·공정관리, 응용솔루션으로 분화되는 단계에 들어섰다.

**승격/관찰 후보 4: Autodesk Forma/Revit 클라우드 연결**
- 관련 신호: 8번, 12번, 16번, 17번, 18번
- 판단: Add-in 결과물 export 형식과 Autodesk Store 문구를 점검한다.
- 이유: Autodesk가 Forma 중심 AECO 클라우드와 Revit 연결을 강화할수록 Add-in은 단독 버튼 기능보다 데이터 내보내기와 협업 흐름이 중요해진다.
