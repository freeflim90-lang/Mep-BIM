...
## BIM Add-in QA 테스트 최신 기준 (2026-06-22)
...
- UI 자동화를 통해 사용자 인터페이스의 변화와 버그를 식별하고, 테스트 스크립트를 작성하여 반복적인 테스트를 자동화한다.
- P1(Priority 1) 버그는 즉시 수정해야 하며, P2(Priority 2) 버그는 우선 순위에 따라 조정하여 해결해야 한다.
