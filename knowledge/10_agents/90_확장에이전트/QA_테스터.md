...
## BIM Add-in QA 테스트 최신 기준 (2026-06-26)
...
- Revit 2023 버전별 회귀 테스트를 진행하여 이전 버전과의 호환성을 확인한다.
- UI 자동화를 위해 TestComplete와 같은 도구를 사용하여 BIM Add-in의 사용자 인터페이스를 자동으로 테스트하도록 설계한다.
- P1(Priority 1) 버그 기준은 시스템의 안전성과 콘텐츠의 정확성을 위협하는 심각한 문제로, 즉시 수정해야 한다.
- P2(Priority 2) 버그는 사용자의 작업 진행을 크게 방해하거나 불편함을 주지만, P1보다는 덜 중요한 문제로, 이 기준에 따른 버그도 신속하게 해결한다.
