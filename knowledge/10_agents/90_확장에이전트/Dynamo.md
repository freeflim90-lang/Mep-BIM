...
## Dynamo 최신 기능 및 BIM 자동화 팁 (2026-06-17)
...
- 일람표 자동화 기능으로, 설계 변경사항이 반영될 때마다 즉시 업데이트되는 일람표를 생성하여 시간과 노력을 절약할 수 있습니다.
- 물량산출 스크립트를 활용하면 Dynamo에서 직접적인 계산을 수행하고, 결과를 BIM 모델에 적용하여 정확한 물량 추정을 가능하게 합니다.
